...
| [04](https://github.com/zousama-git/java-fundamentals/blob/master/journal/perday/Day%204.md)  | Shopping Cart & Conditions | language-fundamentals | if/else, char type | |
| [05](https://github.com/zousama-git/java-fundamentals/blob/master/journal/perday/Day%205.md)  | Random | language-fundamentals | java.util.Random | |
| [06](https://github.com/zousama-git/java-fundamentals/blob/master/journal/perday/Day%206.md)  | Math | language-fundamentals | java.lang.Math | |
| [07](https://github.com/zousama-git/java-fundamentals/blob/master/journal/perday/Day%207.md)  | Strings | language-fundamentals | String methods | |
